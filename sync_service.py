...
Upgrades:
✔ Fetches Spotify audio features (energy, valence, etc.)
✔ Builds real feature vectors for AI scoring
✔ Keeps all safety + rate-limit logic unchanged
✔ Backwards compatible with existing DB schema
"""
...
# ---------------------------------------------------------------------------
# 🔥 NEW: AUDIO FEATURES FETCH (THIS FIXES YOUR VECTOR ISSUE)
# ---------------------------------------------------------------------------

def _get_audio_features(sp, track_id):
    """
    Fetch real Spotify audio features → THIS FIXES EMPTY VECTOR PROBLEM
    """
    try:
