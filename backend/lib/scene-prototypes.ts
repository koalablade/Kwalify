...
export const SCENE_PROTOTYPES: Record<string, ScenePrototype> = {
  ...
  HANGOVER_RECOVERY: {
    id: "hangover_recovery",
    emotionFlow: ["fragile", "gentle", "recovery"],
    energyCurve: "low steady",
    sonicProfileTags: ["soft", "acoustic", "mellow"],
    transitionsTo: ["calm"],
    journeyArc: "recovery",
    excludes: ["hype", "aggressive"],
    profileSeed: { energy: 0.22, valence: 0.42, tension: 0.2, calm: 0.72 },
  },
  DOMESTIC_ROUTINE: {
    id: "domestic_routine",
    emotionFlow: ["routine", "movement", "satisfaction"],
    energyCurve: "medium steady",
    sonicProfileTags: ["pop", "indie", "upbeat"],
    transitionsTo: ["calm"],
    journeyArc: "flat",
    excludes: ["heavy_metal", "deep_sad"],
    profileSeed: { energy: 0.52, valence: 0.58, tension: 0.22, calm: 0.4 },
  },
  PRE_OUT_ENERGY: {
    id: "pre_out_energy",
    emotionFlow: ["anticipation", "confidence", "excitement"],
    energyCurve: "rising",
    sonicProfileTags: ["pop", "dance", "hype"],
    transitionsTo: ["peak"],
    journeyArc: "linear_rise",
    excludes: ["sleepy", "ambient"],
    profileSeed: { energy: 0.68, valence: 0.62, tension: 0.35, calm: 0.2 },
  },
  OVERTHINK_LATE: {
    id: "overthink_late",
    timeBias: "late_night",
    emotionFlow: ["rumination", "softening", "quiet"],
    energyCurve: "low",
    sonicProfileTags: ["ambient", "lo-fi", "sparse"],
    transitionsTo: ["sleep"],
    journeyArc: "slow_burn",
    excludes: ["party", "hype"],
    profileSeed: { energy: 0.2, valence: 0.35, tension: 0.55, calm: 0.55 },
  },
  ROAD_TRIP_ALONE: {
    id: "road_trip_alone",
    motion: "driving",
    emotionFlow: ["freedom", "reflection", "motion"],
    energyCurve: "medium wave",
    sonicProfileTags: ["rock", "indie", "country"],
    transitionsTo: ["arrival"],
    journeyArc: "wave",
    excludes: ["club"],
    profileSeed: { energy: 0.5, valence: 0.55, nostalgia: 0.45, calm: 0.35 },
  },
  SOCIAL_WARMUP: {
    id: "social_warmup",
    emotionFlow: ["warmth", "ease", "connection"],
    energyCurve: "medium",
    sonicProfileTags: ["pop", "indie", "feel-good"],
    transitionsTo: ["social_peak"],
    journeyArc: "linear_rise",
    excludes: ["isolated_cold"],
    profileSeed: { energy: 0.55, valence: 0.65, tension: 0.25, calm: 0.35 },
  },
  GYM_FOCUS: {
    id: "gym_focus",
    emotionFlow: ["drive", "power", "finish"],
    energyCurve: "rising peak",
    sonicProfileTags: ["hip_hop", "rock", "electronic"],
    transitionsTo: ["cooldown"],
    journeyArc: "linear_rise",
    excludes: ["sleepy", "ballad"],
    profileSeed: { energy: 0.78, valence: 0.55, tension: 0.45, calm: 0.15 },
  },
  COFFEE_MORNING: {
    id: "coffee_morning",
    timeBias: "morning",
    emotionFlow: ["soft", "awake", "ready"],
    energyCurve: "low to medium",
    sonicProfileTags: ["indie", "acoustic", "light pop"],
    transitionsTo: ["day"],
    journeyArc: "linear_rise",
    excludes: ["heavy", "dark"],
    profileSeed: { energy: 0.38, valence: 0.55, tension: 0.2, calm: 0.55 },
  },
  STUDY_FOCUS: {
    id: "study_focus",
    emotionFlow: ["focus", "flow", "steady"],
    energyCurve: "medium steady",
    sonicProfileTags: ["instrumental", "lo-fi", "ambient"],
    transitionsTo: ["break"],
    journeyArc: "flat",
    excludes: ["lyrical_distraction", "hype"],
    profileSeed: { energy: 0.42, valence: 0.48, tension: 0.3, calm: 0.62 },
  },
  BREAKUP_WALK: {
    id: "breakup_walk",
    motion: "walking",
    emotionFlow: ["hurt", "processing", "hope"],
    energyCurve: "low wave",
    sonicProfileTags: ["indie", "singer-songwriter", "acoustic"],
    transitionsTo: ["acceptance"],
    journeyArc: "recovery",
    excludes: ["party"],
    profileSeed: { energy: 0.3, valence: 0.32, tension: 0.45, nostalgia: 0.55, calm: 0.4 },
  },
};
