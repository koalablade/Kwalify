...
export const EVERYDAY_WORLD_MAP: EverydayWorld[] = [
  ...
  },
  {
    ...
    label: "dreamy indie / feel something",
    priority: 9,
    patterns: [
      /\b(?:idk just make me feel|make me feel something|cool older sibling|dad would secretly|tumblr|2014 tumblr|indie sleaze|dreamy indie|one world only)\b/i,
      /\b(?:phoebe bridgers|film ending|expensive and cinematic|main character walking)\b/i,
    ],
  },
  {
    ...
    priority: 9,
    patterns: [
      /\b(?:songs that feel like summer|summer vibes|sunny afternoon|latin summer)\b/i,
    ],
  },
  {
  ...
  },
  {
    ...
    patterns: [
      ...
      /\b(?:train delayed|make it bearable|commute)\b/i,
    ],
  },
  {
...
const NAMED_WORLD_RE =
  /\b(?:goth|grunge|disco|synthwave|retrowave|neon|lo-?fi|lofi|ambient|metal|pop[-\s]?punk|uk\s*garage|ukg|grime|shoegaze|darkwave|post[-\s]?punk|boss\s+fight|classic\s+rock|red\s+dirt|drum\s+and\s+bass|dnb|britpop|r&b|hyperpop|jazz|folk|emo|latin|garage\s+workshop)\b/i;
