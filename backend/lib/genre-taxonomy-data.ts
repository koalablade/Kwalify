...
export const GENRE_FAMILIES: GenreFamilyDef[] = [
  ...
  },
  {
    ...
    subgenres: [
      ...
      { id: "uk_drill", microStyles: ["uk drill", "london drill", "sample drill"], patterns: ["uk drill", "london drill", "sample drill", "ukdrill"], artistHints: ["headie one", "digga d", "unknown t", "rv", "central cee"] },
      { id: "drill", microStyles: ["chicago drill", "ny drill", "brooklyn drill"], patterns: ["chicago drill", "ny drill", "brooklyn drill", "\\bdrill\\b"], artistHints: ["pop smoke", "chief keef"] },
      { id: "grime", microStyles: ["uk grime", "140 bpm", "eski", "ruff sqwad"], patterns: ["\\bgrime\\b", "uk grime", "grime classics", "grime workout", "grime walk"], artistHints: ["skepta", "wiley", "stormzy", "dizzee rascal", "jme", "kano", "ghetts", "lethal bizzle", "so solid crew", "chip", "aj tracey", "bugzy malone", "giggs", "novelist", "p money", "flowdan", "roll deep", "jammer", "footsie", "devilman", "lady leshurr", "frisco", "shorty", "meridian crew", "more fire crew", "ruff sqwad", "boy better know"] },
      { id: "uk_rap", microStyles: ["british rap", "road rap", "london rap"], patterns: ["uk rap", "british rap", "road rap", "london rap", "manchester rap", "birmingham rap", "scouse rap"], artistHints: ["dave", "stormzy", "slowthai", "little simz", "headie one", "giggs", "kano", "wretch 32", "tinie tempah", "plan b", "the streets", "mike skinner", "bashy", "ms dynamite", "aitch", "fred again", "central cee", "digga d", "unknown t", "tion wayne", "arrdee"] },
  ...
  },
  {
    ...
    subgenres: [
      ...
      { id: "punk", microStyles: ["punk rock", "post-punk"], patterns: ["punk rock", "\\bpunk\\b", "post-punk"], artistHints: ["blondie", "destructo disk", "ramones", "sex pistols", "the clash", "rancid", "nofx", "bad religion", "pennywise", "dropkick murphys", "anti-flag", "lagwagon", "millencolin", "goldfinger", "pulley", "strung out", "the vandals"] },
      { id: "pop_punk", microStyles: ["mall punk", "skate punk"], patterns: ["pop punk", "pop-punk", "skate punk", "mall punk", "warped tour", "tony hawk"], artistHints: ["green day", "sum 41", "new found glory", "good charlotte", "simple plan", "bowling for soup", "all time low", "the offspring", "yellowcard", "mxpx", "less than jake", "zebrahead", "jimmy eat world", "fall out boy", "paramore", "panic!?.*disco", "the all-american rejects", "all american rejects", "mayday parade", "boys like girls", "motion city soundtrack", "the starting line", "saves the day", "the ataris", "alkaline trio", "sugarcult", "cartel", "we the kings", "forever the sickest kids", "cobra starship", "cute is what we aim for", "the academy is", "the maine", "plain white t'?s"] },
      { id: "post_hardcore", microStyles: ["screamo", "emo hardcore", "melodic hardcore"], patterns: ["post hardcore", "post-hardcore", "screamo", "melodic hardcore"], artistHints: ["alexisonfire", "funeral for a friend", "thursday", "senses fail", "from first to last", "silverstein", "underoath", "the used", "taking back sunday", "brand new", "saosin", "hawthorne heights", "escape the fate", "a day to remember", "enter shikari", "fightstar", "lostprophets", "bullet for my valentine"] },
      { id: "post_rock", microStyles: ["instrumental rock"], patterns: ["post-rock", "post rock", "crescendo rock"] },
      { id: "emo", microStyles: ["emo pop", "screamo"], patterns: ["\\bemo\\b", "emo pop", "midwest emo", "scene kid", "myspace emo"], artistHints: ["my chemical romance", "fall out boy", "panic!?.*disco", "paramore", "jimmy eat world", "taking back sunday", "dashboard confessional", "brand new", "mayday parade", "the all-american rejects", "all american rejects", "the used", "hawthorne heights", "saves the day", "motion city soundtrack", "dashboard confessional", "say anything", "hellogoodbye", "cute is what we aim for", "the red jumpsuit apparatus", "story of the year"] },
  ...
  },
  {
    ...
    subgenres: [
      ...
      { id: "trance", microStyles: ["classic trance", "90s trance", "driving trance"], patterns: ["\\btrance\\b", "90s trance", "nineties trance", "classic trance", "driving trance"] },
      { id: "uplifting_trance", microStyles: ["uplifting trance", "euphoric trance", "euro trance"], patterns: ["uplifting trance", "euphoric trance", "euro trance"] },
      ...
      { id: "jungle", microStyles: ["jungle", "ragga jungle", "dark jungle", "atmospheric jungle"], patterns: ["\\bjungle\\b", "ragga jungle", "dark jungle", "atmospheric jungle", "old school jungle", "old skool jungle"] },
      { id: "ambient", microStyles: ["dark ambient", "ambient electronic"], patterns: ["\\bambient\\b", "dark ambient", "soundscape"] },
      { id: "dubstep", microStyles: ["old school dubstep", "uk dubstep", "deep dubstep", "brostep", "riddim"], patterns: ["dubstep", "old school dubstep", "oldschool dubstep", "old skool dubstep", "uk dubstep", "deep dubstep", "riddim", "brostep"] },
      { id: "bloghouse", microStyles: ["bloghouse", "blog house", "nu rave", "french electro"], patterns: ["bloghouse", "blog house", "electro bloghouse", "nu rave", "new rave", "french electro", "ed banger", "blog era electro"] },
  ...
  },
  {
    ...
    subgenres: [
      {
        id: "motown",
        microStyles: ["detroit soul"],
        patterns: ["motown", "detroit soul"],
        artistHints: [
          "stevie wonder",
          "marvin gaye",
          "supremes",
      ...
      { id: "neo_soul", microStyles: ["alternative rnb"], patterns: ["neo soul", "neo-soul"], artistHints: ["sharon jones", "charles bradley", "lee fields", "amy winehouse"] },
      {
        id: "funk",
        microStyles: ["p funk", "funk soul"],
        patterns: ["\\bfunk\\b", "p-funk", "funk soul", "boogie"],
        artistHints: [
          "funkadelic",
          "parliament",
          "george clinton",
      ...
      {
        id: "disco",
        microStyles: ["classic disco", "nu disco", "disco funk"],
        patterns: ["\\bdisco\\b", "nu.?disco", "italo disco", "post.?disco", "hi.?nrg", "eurodisco"],
        artistHints: [
          "donna summer",
          "bee gees",
          "\\bchic\\b",
  ...
  },
  {
    ...
    subgenres: [
      ...
      { id: "city_pop", microStyles: ["city pop", "japanese city pop", "late night city pop"], patterns: ["city pop", "citypop", "city-pop", "japanese city pop", "late night city pop", "80s city pop"] },
  ...
  },
  {
    ...
    subgenres: [
      ...
      { id: "singer_songwriter", microStyles: ["acoustic folk", "unplugged"], patterns: ["singer-songwriter", "singer songwriter", "acoustic folk", "acoustic version", "unplugged", "acoustic session", "mtv unplugged", "\\- acoustic"], artistHints: ["gregory alan isakov", "iron.*wine"] },
  ...
  },
  {
    family: "reggae",
    subgenres: [
      { id: "roots_reggae", microStyles: ["dub", "rocksteady", "beach reggae", "island reggae"], patterns: ["\\breggae\\b", "roots reggae", "rocksteady", "\\bdub\\b", "beach reggae", "sunset reggae", "island reggae", "summer reggae"], artistHints: ["bob marley", "peter tosh", "lee scratch"] },
