...
export const GENRE_FAMILIES: GenreFamilyDef[] = [
  ...
  },
  {
    ...
    subgenres: [
      ...
      { id: "punk", microStyles: ["punk rock", "post-punk"], patterns: ["punk rock", "\\bpunk\\b", "post-punk"], artistHints: ["blondie", "destructo disk", "ramones", "sex pistols", "the clash", "rancid", "nofx", "bad religion", "pennywise"] },
      { id: "pop_punk", microStyles: ["mall punk", "skate punk"], patterns: ["pop punk", "pop-punk", "skate punk"], artistHints: ["blink[-\\s]?182", "green day", "sum 41", "new found glory", "good charlotte", "simple plan", "bowling for soup", "all time low", "the offspring", "yellowcard", "mxpx", "less than jake", "zebrahead"] },
      { id: "post_hardcore", microStyles: ["screamo", "emo hardcore", "melodic hardcore"], patterns: ["post hardcore", "post-hardcore", "screamo", "melodic hardcore"], artistHints: ["alexisonfire", "funeral for a friend", "thursday", "senses fail", "from first to last", "silverstein", "underoath", "the used"] },
      { id: "post_rock", microStyles: ["instrumental rock"], patterns: ["post-rock", "post rock", "crescendo rock"] },
      { id: "emo", microStyles: ["emo pop", "screamo"], patterns: ["\\bemo\\b", "emo pop", "midwest emo"], artistHints: ["my chemical romance", "fall out boy", "panic!?.*disco", "paramore", "jimmy eat world", "taking back sunday", "dashboard confessional", "brand new", "mayday parade", "the all-american rejects", "all american rejects"] },
