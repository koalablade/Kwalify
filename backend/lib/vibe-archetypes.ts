...
export const VIBE_ARCHETYPES: VibeArchetype[] = [
  ...
  },
  {
    ...
    terms: ["driving home at 11", "driving home at 11pm", "driving home", "drive home", "going home", "mentally drained commute", "drive home exhausted"],
  ...
  {
    id: "petrol_station_driving_home",
    label: "Petrol Station Drive Home",
    terms: [
      "petrol station 2am driving home",
      "petrol station 2 am driving home",
      "gas station 2am driving home",
      "petrol station driving home",
      "service station driving home",
    ],
    defaultVibe: "petrol station 2am driving home night cruise cool car reflective not sad",
    journeyArc: "flat",
    weights: { energy: 0.12, valence: 0.18, tension: 0.08, nostalgia: 0.12, calm: -0.05 },
    sceneHints: { timeOfDay: "late_night", motionState: "driving", environment: "urban" },
  },
  {
    ...
    terms: [
      ...
      "empty petrol station 2am",
      "empty petrol station 2am alone",
      "petrol station at 2am",
      "gas station at 2am",
      "service station fluorescent",
      "petrol station fluorescent lonely",
    ],
    defaultVibe: "petrol station at 2am fluorescent lonely empty alone",
    journeyArc: "slow_burn",
    weights: { energy: -0.05, valence: -0.22, tension: 0.28, nostalgia: 0.35, calm: 0.15 },
