...
export const EXPANDED_GENRE_ALIASES: GenreAliasGroup[] = [
  ...
  { family: "electronic", terms: ["uk garage", "ukg", "garage", "2-step", "two step garage", "speed garage", "future garage", "bassline", "donk", "breakbeat", "breaks", "idm", "glitch", "downtempo", "trip hop", "trip-hop", "chillout", "deep house", "tech house", "progressive house", "acid house", "electro", "electroclash", "minimal techno", "hard techno", "gabber", "hardstyle", "happy hardcore", "breakcore", "liquid dnb", "neurofunk", "footwork", "juke", "jersey club", "future bass", "wave", "vaporwave", "hyperpop", "pc music"] },
