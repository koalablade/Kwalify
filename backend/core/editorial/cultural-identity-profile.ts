...
const CULTURAL_PROFILES: Record<string, CulturalWorldProfile> = {
  ...
  uk_garage_world: {
    ...
    adjacentArtists: ["DJ Luck & MC Neat", "Wookie", "DJ EZ", "P Money", "Chip", "TeeDee"],
    majorArtists: ["P Money", "Chip", "Wookie", "DJ EZ", "DJ Luck & MC Neat"],
    deepCuts: ["TeeDee", "Heartless Crew", "Platinum 45", "Sticky", "DJ Pied Piper"],
    acceptableAdjacency: ["P Money", "Chip", "Wookie", "DJ EZ", "Heartless Crew"],
    avoidArtists: [
      "Bon Iver",
      "Phoebe Bridgers",
      "Fleetwood Mac",
    ...
    avoidGenres: ["country", "classic rock", "yacht rock", "americana", "acoustic folk", "indie folk"],
    anchorTracks: [/\bre-?rewind\b/i, /\b7\s+days\b/i, /\bwhen\s+the\s+bassline\s+drops\b/i],
    preferredEras: { min: 1998, max: 2018 },
    energyRange: { min: 0.45, max: 0.88 },
    instrumentation: ["uk garage", "2-step", "bassline", "speed garage"],
    vocalStyle: ["uk garage", "grime-adjacent", "dancehall"],
    forbiddenArtists: [
      ...LANDFILL,
      /\bfleetwood\s+mac\b/i,
      /\bled\s+zeppelin\b/i,
    ...
    forbiddenPatterns: [
      /\b(?:country|classic\s+rock|arena\s+rock|yacht\s+rock|americana|acoustic\s+ballad)\b/i,
    ],
    openerRules: {
      minWorldIdentityScore: 0.8,
      preferAnchorArtist: true,
  ...
  pop_punk_world: {
    ...
    anchorArtists: [
      ...
      /\bparamore\b/i,
      /\bfall\s+out\s+boy\b/i,
      /\bjimmy\s+eat\s+world\b/i,
      /\ball[-\s]?american\s+rejects\b/i,
      /\bmy\s+chemical\s+romance\b/i,
      /\bnew\s+found\s+glory\b/i,
      /\bgood\s+charlotte\b/i,
      /\bsimple\s+plan\b/i,
      /\byellowcard\b/i,
    ],
    anchorArtistNames: [
    ...
    adjacentArtists: ["Taking Back Sunday", "The Used", "All Time Low", "Panic! At The Disco", "The Offspring"],
    majorArtists: ["Taking Back Sunday", "The Used", "All Time Low", "Simple Plan", "Good Charlotte"],
    deepCuts: ["The Starting Line", "Motion City Soundtrack", "Sugarcult", "The Ataris"],
    acceptableAdjacency: ["Taking Back Sunday", "The Used", "All Time Low", "The Offspring"],
    avoidArtists: [
      "Bon Iver",
      "Phoebe Bridgers",
      "Fleetwood Mac",
    ...
    avoidGenres: ["classic rock", "arena rock", "yacht rock", "disco", "country", "uk garage"],
    anchorTracks: [/\bamerican\s+idiot\b/i, /\bwhat'?s\s+my\s+age\s+again\b/i, /\bstill\s+waiting\b/i],
    preferredEras: { min: 1998, max: 2012 },
    energyRange: { min: 0.62, max: 0.98 },
    instrumentation: ["pop punk", "punk rock", "emo", "easycore"],
    vocalStyle: ["punk", "emo", "anthemic"],
    forbiddenArtists: [
      ...LANDFILL,
      /\bfleetwood\s+mac\b/i,
      /\bled\s+zeppelin\b/i,
    ...
    forbiddenPatterns: [
      /\b(?:classic\s+rock|arena\s+rock|yacht\s+rock|disco|country|uk\s+garage|grime)\b/i,
    ],
    openerRules: {
      minWorldIdentityScore: 0.8,
      preferAnchorArtist: true,
  ...
  gym_energy_world: {
    ...
    majorArtists: ["Fred again..", "Calvin Harris", "Disclosure", "Marshmello", "Central Cee"],
    deepCuts: ["999999999", "Regal", "Kobosil", "ANNA", "I Hate Models"],
    acceptableAdjacency: ["Fred again..", "Calvin Harris", "Disclosure", "Marshmello", "Central Cee"],
    avoidArtists: [
      "AC/DC",
      "Guns N' Roses",
      "Led Zeppelin",
    ...
    avoidGenres: ["classic rock", "arena rock", "hard rock", "yacht rock", "acoustic folk"],
    anchorTracks: [/\b(?:techno|warehouse|industrial)\b/i],
    preferredEras: { min: 1995, max: 2026 },
    energyRange: { min: 0.65, max: 0.98 },
    instrumentation: ["techno", "house", "edm", "electronic", "hip hop"],
    vocalStyle: ["dance", "workout", "hype"],
    forbiddenArtists: [
      ...LANDFILL,
      /\bac\/?dc\b/i,
      /\bguns\s+n['']?\s*roses\b/i,
    ...
    forbiddenPatterns: [
      /\b(?:classic\s+rock|arena\s+rock|hard\s+rock|heavy\s+metal|thrash|yacht\s*rock|soft\s*rock)\b/i,
      /\b(?:acoustic|folk|singer[-\s]?songwriter|ballad)\b/i,
      /\b(?:pop\s*punk|skate\s*punk|emo\b|easycore)\b/i,
    ],
    openerRules: {
      minWorldIdentityScore: 0.75,
      preferAnchorArtist: true,
      anchorBeatsAdjacent: true,
      sequencing: "high_energy_cooldown",
    },
  ...
  reggae_world: {
    ...
    adjacentArtists: ["Inner Circle", "Ziggy Marley", "Stephen Marley", "Koffee", "Protoje", "Chronixx", "Popcaan"],
    majorArtists: ["Bob Marley", "Sean Paul", "Damian Marley", "Shaggy", "UB40"],
    deepCuts: ["Burning Spear", "Gregory Isaacs", "Dennis Brown", "Toots and the Maytals", "Steel Pulse"],
    acceptableAdjacency: ["Inner Circle", "Ziggy Marley", "Stephen Marley", "Koffee", "Protoje"],
    avoidArtists: [
      "MGMT",
      "Wallows",
      "The 1975",
    ...
    avoidGenres: ["indie pop", "dream pop", "bedroom pop", "surf rock", "chillwave"],
    anchorTracks: [/\b(?:reggae|dub|dancehall|rocksteady)\b/i, /\b(?:three\s+little\s+birds|no\s+woman|jammin|get\s+busy)\b/i],
    preferredEras: { min: 1968, max: 2026 },
    energyRange: { min: 0.35, max: 0.78 },
    instrumentation: ["reggae", "roots reggae", "dub", "dancehall", "rocksteady", "ska"],
    vocalStyle: ["island", "roots", "dancehall"],
    forbiddenArtists: [
      ...LANDFILL,
      /\bmgmt\b/i,
      /\bwallows\b/i,
    ...
    forbiddenPatterns: [/\b(?:indie\s+pop|dream\s+pop|bedroom\s+pop|surf\s+rock|chillwave|trop\s+house)\b/i],
    openerRules: {
      minWorldIdentityScore: 0.75,
      preferAnchorArtist: true,
      anchorBeatsAdjacent: true,
