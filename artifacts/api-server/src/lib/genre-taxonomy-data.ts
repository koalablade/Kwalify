...
export const GENRE_FAMILIES: GenreFamilyDef[] = [
  ...
  },
  {
    ...
    subgenres: [
      ...
      { id: "melodic_rap", microStyles: ["emo rap", "sad rap"], patterns: ["melodic rap", "emo rap", "sing rap"] },
  ...
  },
  {
    ...
    subgenres: [
      ...
      { id: "classic_rock", microStyles: ["arena rock", "70s rock"], patterns: ["classic rock", "rock legend", "hard rock classic"], artistHints: ["led zeppelin", "queen", "ac/dc", "fleetwood mac"] },
      { id: "punk", microStyles: ["pop punk", "post-punk"], patterns: ["punk rock", "\\bpunk\\b", "pop punk", "post-punk"] },
