...
const CANONICAL_FAMILY: Record<string, SceneFamily> = {
  ...
  rain_windscreen_night_drive: "night_introspective",
...
const FAMILY_PATTERNS: { family: SceneFamily; re: RegExp; weight: number }[] = [
  ...
  { family: "travel_driving", re: /\b(driving|motorway|highway|road trip|train|commute|airport|transit)\b/i, weight: 0.8 },
